...
import { Deposit } from '../../../entities/private/invest/deposit.entity';
...
export class DepositService {
  ...
  public async findOne(id: string): Promise<Deposit> {
    return await this.repo.findOneBy({ id });
  }

  public async create(deposit: DepositDTO): Promise<Deposit> {
    return await this.repo.save(deposit);
  }

  public async update(id: string, deposit: DepositDTO): Promise<UpdateResult> {
